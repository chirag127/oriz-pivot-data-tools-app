---
type: index
title: "oriz-pivot-data-tools-app — knowledge bundle"
description: "App-specific knowledge for oriz-pivot-data-tools-app. Cross-cutting family rules live at master `c:/D/oriz/knowledge/`."
tags: [okf, index, app, pivot-data-tools]
timestamp: 2026-06-21
format_version: okf-v0.1
status: active
---

# oriz-pivot-data-tools-app — knowledge bundle

This is the per-app OKF-light bundle for **oriz-pivot-data-tools-app**. App-specific facts only. Cross-cutting family rules / decisions / services live at master [`../../../../knowledge/`](../../../../knowledge/).
...
- **Category**: tools
- **Family role**: Data and spreadsheet utilities under the Pivot product brand.
